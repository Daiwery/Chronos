...
class UnionScheduleFragment : Fragment() {
    ...
    private inner class ActionTypeHolder(binding: ItemRecyclerViewActionTypeBinding): ActionTypeRawHolder(binding){
        override fun onClick() {
            ...
            itemView.findNavController().navigate(R.id.action_navigation_union_schedule_to_navigation_union_action_type, bundle)
        }
    ...
    private inner class GoalHolder(binding: ItemRecyclerViewGoalBinding) : GoalRawHolder(binding){
        override fun onClick() {
            ...
            itemView.findNavController().navigate(R.id.action_navigation_union_schedule_to_navigation_union_goal, bundle)
        }
    ...
    private inner class ScheduleHolder(binding: ItemRecyclerViewScheduleBinding): ScheduleRawHolder(binding) {
        override fun onClick() {
            ...
            itemView.findNavController().navigate(R.id.action_navigation_union_schedule_self, bundle)
        }
