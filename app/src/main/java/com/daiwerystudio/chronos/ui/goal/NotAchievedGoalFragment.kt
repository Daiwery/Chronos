...
/**
 * Класс фрагмента, показывающий незавершенные цели. Практически идентичен ActionTypeFragment. За
 * тем исклчючение, что помимо кнопки "изменить" еще есть CheckBox для
 * изменения состояния isAchieved цели.
 * @see NotAchievedGoalViewModel
 */
class NotAchievedGoalFragment: Fragment() {
    ...
    */
    ...
    /**
     * Класс Holder-а для RecyclerView.
     * После нажатия на CheckBox цели и все дерево становятся выполнены.
     */
